...
namespace Content.Server.Collard.Maps.NameGenerators;

[UsedImplicitly]
public sealed partial class CollardNameGenerator : StationNameGenerator
{
    /// <summary>
    ...
    private string Prefix => "CG"; // collard-greens
