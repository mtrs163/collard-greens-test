...
public sealed partial class RadioDeviceSystem : SharedRadioDeviceSystem
{
    ...
    [Dependency] private AudioSystem _audio = default!; // collard-Soundworks
    ...
    private void OnReceiveRadio(EntityUid uid, RadioSpeakerComponent component, ref RadioReceiveEvent args)
    {
        ...
        _audio.PlayPvs(args.Channel.MessageSound, uid, AudioParams.Default.AddVolume(-3)); // collard-Soundworks
