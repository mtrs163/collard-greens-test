...
public sealed partial class HumanoidCharacterProfileV1
{
    ...
    {
        return new(Name, FlavorText, Pose, Species, Age, Sex, ERPStatus, GetDefaultVoice(Species, Sex), Gender, Appearance.ToV2(Species), SpawnPriority, JobPriorities, PreferenceUnavailable, AntagPreferences, TraitPreferences, Loadouts);
    }
