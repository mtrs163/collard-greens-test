...
public sealed partial class PortalComponent : Component
{
    ...
    public SoundSpecifier ArrivalSound = new SoundCollectionSpecifier("PortalArrival"); //collard-Soundworks

    /// <summary>
    ///     Sound played on departing from this portal, centered on the original portal.
    /// </summary>
    [DataField("departureSound")]
    public SoundSpecifier DepartureSound = new SoundCollectionSpecifier("PortalDeparture"); //collard-Soundworks
