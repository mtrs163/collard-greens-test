...
ghost-role-information-closet-skeleton-description = Вы - первозданная сила, не имеющая хозяина. Живите счастливо с экипажем и устраивайте интересные ситуации.
...
ghost-role-information-cburn-agent-name = Сотрудник службы РХБЗ
...
ghost-role-information-nukeop-rules = Вы [color={role-type-team-antagonist-color}][bold]{role-type-team-antagonist-name}[/bold][/color], в команде с другими Ядерными оперативниками. Помощь агентов на станции не гарантируется. Несмотря на то, что вы - антагонист, не забывайте о том, что вы всё ещё должны отыгрывать и стремиться к созданию РП-ситуаций.
...
ghost-role-information-syndicate-reinforcement-medic-description = Кому-то нужно подкрепление. Ваша задача - сохранить жизнь вызвавшему вас агенту. Несмотря на то, что вы - антагонист, не забывайте о том, что вы всё ещё должны отыгрывать и стремиться к созданию РП-ситуаций.
