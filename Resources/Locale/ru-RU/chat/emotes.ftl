...
chat-emote-name-gasp = Втянуть воздух
chat-emote-name-deathgasp = Испустить последний вздох
...
chat-emote-name-catmeow = Мяукать по-кошачьи
chat-emote-name-cathisses = Шипеть по-кошачьи
chat-emote-name-monkeyscreeches = Кричать по-обезьяньи
...
chat-emote-msg-gasp = пытается вдохнуть.
