...
trait-blindness-desc = Вы законно признанный слепой и не можете видеть дальше нескольких метров перед собой.
...
trait-narcolepsy-desc = Вы можете уснуть в любой случайный момент.
...
trait-scottish-desc = Вы разговариваете как настоящий скот.
...
trait-hemophilia-desc = Ваше тело не может нормально сворачивать кровь.

trait-impaired-mobility-name = Ограниченная подвижность
trait-impaired-mobility-desc = У вас есть трудности с ходьбой без помощи инструментов.
