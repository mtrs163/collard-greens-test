...
## Команды
ghost-respawn-command-desc = Возвращает вас в лобби, если вы подходите.
ghost-respawn-not-a-ghost = Вы не призрак.
ghost-respawn-ineligible = Вы пока не подходите.
## Уведомление админов
ghost-respawn-admin-notification = Игрок { $plrname } вышел в лобби!
