...
game-ticker-player-join-game-message = Добро пожаловать на сервер Green! Если вы играете впервые, обязательно нажмите ESC на клавиатуре и прочитайте правила игры и загляните во внутриигровое руководство, а также не бойтесь просить помощи в "Админ помощь" (F1).
game-ticker-get-info-text =
    Привет и добро пожаловать на [color=green]Green![/color]
...
latejoin-arrival-announcement =
    { $job } { $character } { GENDER($entity) ->
        [male] был назначен
        [female] была назначена
        [epicene] были назначены
       *[neuter] было назначено
    } на смену!
latejoin-arrival-announcement-special = { $job } "{ $character }" инициализирован и готов к работе!
