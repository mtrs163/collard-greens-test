cryostorage-insert-message-permanent = [color=white]Вы внутри [bold][color=cyan]капсулы криогенного сна[/color][/bold]. Если вы [bold]отключитесь[/bold], [bold]уйдёте в призраки[/bold], или [bold]прождёте { $time } минут[/bold], [color=red]ваше тело будет удалено[/color] и слот вашей должности будет открыт. Чтобы этого не произошло, вы можете в любой момент покинуть капсулу. Помните, что если ваше тело будет удалено капсулой, вы [bold][color=red]не можете вернуться в раунд за того же персонажа[/color][/bold].[/color]
cryostorage-insert-message-temp = [color=white]Вы внутри [bold][color=cyan]капсулы криогенного сна[/color][/bold]. Если вы [bold]уйдёте в призраки[/bold] или [bold]прождёте { $time } минут[/bold], [color=red]ваше тело будет удалено[/color] и слот вашей должности будет открыт. Если вы [bold][color=cyan]отключитесь[/color][/bold], ваше тело будет надёжно храниться до тех пор, пока вы не переподключитесь. Помните, что если ваше тело будет удалено капсулой, вы [bold][color=red]не можете вернуться в раунд за того же персонажа[/color][/bold].[/color]
