...
radio-jammer-component-set-message-high = Глушитель теперь работает на высокой мощности.
radio-jammer-component-set-message-medium = Глушитель теперь работает на средней мощности.
radio-jammer-component-set-message-low = Глушитель теперь работает на низкой мощности.
radio-jammer-component-switch-setting = Переключатель уровня мощности установлен на "[color=yellow]{ $powerLevel }[/color]".
