...
ent-CrateServiceColorfulLights = ящик цветных лампочек
    .desc = Это нельзя назвать вечеринкой, пока в глазах не появится рябь и уши не будут болеть.
ent-CrateServiceCleanerGrenades = оптовая закупка чистящих гранат
    .desc = Содержит две коробки чистящих гранат, чтобы отмыть особо въевшиеся пятна.
