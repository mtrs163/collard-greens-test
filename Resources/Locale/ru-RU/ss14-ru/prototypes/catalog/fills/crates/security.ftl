...
ent-CrateSecNonlethalThrowables = ящик нелетального метательного оружия
    .desc = Содержит по одной коробке светошумовых гранат, стингеров, гранат слезоточивого газа и четыре болы. Требует доступ Службы Безопасности для открытия.
