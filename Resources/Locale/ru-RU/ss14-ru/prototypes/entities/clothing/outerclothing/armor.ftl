...
ent-ClothingOuterArmorCentcommCarapace = панцирь центком
    .desc = Бронированный нагрудник, обеспечивающий защиту и при этом обладающий мобильностью и гибкостью. Выдаётся только представителям и агентам ЦентКом.
...
ent-CardArmour = картонные доспехи
    .desc = Средневековая кираса из картона.
