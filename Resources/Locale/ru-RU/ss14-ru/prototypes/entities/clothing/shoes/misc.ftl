...
ent-ClothingShoesBootsJump = прыгуны
    .desc = Высокотехнологичные ботинки, которые дают вам невероятную возможность ПРЫГАТЬ! С этими ботинками вы можете перепрыгивать через лаву, бездны и странные химикаты на полу.
