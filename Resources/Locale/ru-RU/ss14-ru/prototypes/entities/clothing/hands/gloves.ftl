...
ent-ClothingHandsKnuckleDustersBrass = латунные кастеты
    .desc = Латунные кастеты, точь-в-точь как обычные и бьют так же больно.
ent-ClothingHandsKnuckleDustersQM = золотые кастеты Квартирмейстера
    .desc = 24-каратное золото с добавлением пластали и брендированное логотипом НаноТрейзен. Настоящий символ мощи Квартирмейстера.
ent-ClothingHandsKnuckleDustersSyndicate = кастеты синдиката
    .desc = Пластитановые кастеты, брендированные кроваво-красной S. Настоящий мужчина забьёт ими кого-нибудь до смерти.
ent-ClothingHandsKnuckleDustersStun = кастеты-шокеры
    .desc = Пара кастетов, соединённых с технологией дубинки-шокера.
ent-ClothingHandsKnuckleBoneCrushers = костоправы
    .desc = Благословлены Богами на уничтожение всех, кто им не подчиняется.
