...
ent-ClothingNeckCloakSalvagerSupreme = плащ профессионального утилизатора
    .desc = Его носят самые умелые специалисты по утилизации, которые обуздали космос и сделали копание астероидов своей специальностью. Такое просто так не выдают, понимаешь?
