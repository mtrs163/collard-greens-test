...
ent-PosterContrabandWehWatches = большой Weh следит за тобой
...
ent-PosterContrabandRealExomorph = Экзоморф! Настоящий!
    .desc = Конспирологический плакат об опасных формах жизни.
ent-PosterContrabandExoAcid = Предупреждение об Экзоморфах: Кислотный Плевок! 
    .desc = Этот плакат предупреждает о кислотных плевках экзоморфов. Не то, чтобы они были настоящими... Ведь так?
ent-PosterContrabandExoRun = Предупреждение об Экзоморфах: Убегайте!
    .desc = Этот плакат предупреждает об атлетичном экзоморфе, способном утащить любого, кого сумеет поймать; так что не поймайтесь!
ent-PosterContrabandExoChomp = Предупреждение об Экзоморфах: Опасные Укусы!
    .desc = Этот лакат предупреждает о летальности укусов экзоморфов. Не становитесь закуской пришельцев!