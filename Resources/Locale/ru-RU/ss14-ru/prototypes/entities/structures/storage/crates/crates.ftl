...
ent-CrateBaseLockBox = ящик с замком
    .desc = Защищённый ящик с замком. Доходы с его продажи будут отправлены обратно в отдел. Просто помните: Снабжение всегда берёт долю.
...
ent-CrateLockBoxService = сервисный ящик с замком
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxSecurity = ящик с замком службы безопасности
    .desc = { ent-CrateBaseLockBox.desc }
