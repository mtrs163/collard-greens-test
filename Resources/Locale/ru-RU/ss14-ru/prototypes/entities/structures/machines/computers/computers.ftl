...
ent-ComputerCargoOrders = консоль запросов снабжения
...
ent-ComputerCargoOrdersEngineering = консоль запросов инженерного отдела
    .desc = Используется для оформления запросов инженерного отдела.
ent-ComputerCargoOrdersSecurity = консоль запросов службы безопасности
    .desc = Используется для оформления запросов службы безопасности.
ent-ComputerCargoOrdersService = консоль запросов сервисного отдела
    .desc = Используется для оформления запросов сервисного отдела.
ent-ComputerCargoOrdersScience = консоль запросов научного отдела
    .desc = Используется для оформления запросов научного отдела.
ent-ComputerCargoOrdersMedical = консоль запросов медицинского отдела
    .desc = Используется для оформления запросов медицинского отдела.
ent-ComputerFundingAllocation = консоль распределения бюджета
    .desc = Терминал для контроля распределения средств и платы отделам.
ent-ComputerSalvageJobBoard = консоль утилизационных работ
    .desc = Консоль, дающая доступ к работам по утилизации, если вы до них доросли.
ent-StationAiFixerComputer = консоль исправления ИИ
    .desc = Используется для исправления сломанных ИИ.
ent-ComputerXenoborgsControl = консоль управления ксеноборгами
    .desc = Используется для мониторинга всех ксеноборгов.
ent-ComputerSurveillanceWirelessXenoborgCameraMonitor = монитор камер ксеноборгов
    .desc = Монитор беспроводных камер ксеноборгов. Вы смотрите за ними. Наверное.
ent-ComputerNukieDelivery = консоль поставок синдиката
    .desc = Компьютер, способный блюспейсить некоторую экипировку для Ядерных Операций. Плата интегрирована в рамку и не может быть извлечена.
