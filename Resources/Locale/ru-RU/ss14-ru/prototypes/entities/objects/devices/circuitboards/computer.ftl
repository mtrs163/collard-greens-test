...
ent-CargoRequestComputerCircuitboard = консоль запросов снабжения (консольная плата)
    .desc = Консольная плата для консоли запросов снабжения.
...
ent-CargoRequestScienceComputerCircuitboard = консоль запросов научного отдела (консольная плата)
    .desc = Консольная плата для консоли запросов научного отдела.
ent-CargoRequestServiceComputerCircuitboard = консоль запросов сервисного отдела (консольная плата)
    .desc = Консольная плата для консоли запросов сервисного отдела.
ent-CargoRequestEngineeringComputerCircuitboard = консоль запросов инженерного отдела (консольная плата)
    .desc = Консольная плата для консоли запросов инженерного отдела.
...
ent-WeaponEnergyTurretCommandControlPanelElectronics = панель управления защитными турелями (консольная плата)
    .desc = Консольная плата для панели управления защитными турелями.
    .suffix = Командование
ent-WeaponEnergyTurretAIControlPanelElectronics = панель управления защитными турелями (консольная плата)
    .desc = Консольная плата для панели управления защитными турелями.
    .suffix = ИИ, Синтетики
ent-WeaponEnergyTurretSecurityControlPanelElectronics = панель управления защитными турелями (консольная плата)
    .desc = Консольная плата для панели управления защитными турелями.
    .suffix = СБ
...
ent-StationAiFixerCircuitboard = консоль исправления ИИ (консольная плата)
    .desc = Консольная плата для консоли исправления ИИ.
