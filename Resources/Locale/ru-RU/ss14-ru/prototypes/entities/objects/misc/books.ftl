...
ent-BookSpaceEncyclopedia = Космическая энциклопедия
    .desc = Энциклопедия, содержащая все знания мира. Вам всё равно не удаётся ничего понять. Автор неизвестен.
ent-BookTheBookOfControl = Как ходить
    .desc = Необходима для достижения контроля над своим телом.
