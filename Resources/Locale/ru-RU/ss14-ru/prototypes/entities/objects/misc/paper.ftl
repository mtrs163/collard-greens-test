...
ent-PaperSalvageJobLabel = лист поставки утилизационных работ
    .desc = Бумажная маркировка, обозначающая ящик как содержащий поставку для выполнения работы по утилизации. Продажа ящика с этим выполнит работу.
