...
ent-WeaponTemperatureGun = температурное ружьё
    .desc = Продвинутое ружьё, стреляющее лучами, меняющими температуру тела. Вероятно, это нарушает какую-то конвенцию.
